export function Footer() {
    return (
        <footer className="w-full bg-main-500 h-auto py-4">
            <div className="flex flex-row flex-wrap justify-between items-center mx-auto max-w-7xl gap-y-4 text-center">
